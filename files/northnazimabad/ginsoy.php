            ...
            <div class="restaurant-hero-grid">
                ...
                <div class="restaurant-info">
                    ...
                    <div class="restaurant-meta">
                        ...
                        <span>🍽️ Chinese cuisine</span>
                        <span>4,400+ Reviews</span>
                    </div>
                    ...
                    <div class="restaurant-actions">
                        <a href="https://www.google.com/maps/place/Ginsoy+Hyderi+Branch"
                            class="btn btn-primary">Get Directions</a>
                        <a href="https://www.google.com/search?q=ginsoy+restaurant+hyderi+menu#vhid=33:/g/11b7kl4yj4&vssid=menu-viewer-entrypoint" class="btn btn-outline">View Menu</a>
                    </div>
                </div>

                <!-- RIGHT IMAGE -->
                <div class="restaurant-image">
                    <img src="../images/ginsoy.PNG" alt="Ginsoy restaurant dining area. family seating" />
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="details-grid">
                ...
                <div class="details-main">
                    ...
                    <ul class="restaurant-highlights">
                        <li>✔ Premium Chinese cuisine with consistent quality</li>
                        <li>✔ Family-friendly and spacious dining area</li>
                        <li>✔ Efficient online ordering service for home delivery</li>
                        <li>✔ Popular dishes include chow mein, dynamite prawns, and sweet and sour chicken</li>
                    </ul>

                    <h3>What People Are Saying</h3>
                    <p>
                        Customers have shared overwhelmingly positive reviews of Ginsoy Restaurant:
                    </p>
                    <ul class="reviews-list">
                        <li>"Best Chinese in North Nazimabad."</li>
                        <li>"The best Chinese restaurant we experienced in a while... The ambiance, the staff, the food, the serving quantities... All are thumbs up"</li>
                        <li>The food was excellent, no doubt, and the portion size was very generous as well.</li>
                        <li>"Price is slightly expensive but worth the money."</li>
                        <li>It's very classic outside and super luxurious inside, a well maintained ambiance with comfortable sitting, and a cooperative staff, this makes this place a memorable place, we have tried their signature soup, and chicken corn soup, they have helped me to select order as well as quantity, parking is not very much spacious but well maintained and managed. Valet available outside for your parking needs.</li>
                    </ul>
                ...
                <aside class="details-sidebar">
                    ...
                    <div class="info-card">
                        <h3>Quick Links</h3>
                        <a href="https://www.google.com/search?q=ginsoy+restaurant+hyderi+menu">View Menu</a>
                        <a href="https://www.google.com/search?q=ginsoy+restaurant+hyderi+menu#vhid=33:/g/11b7kl4yj4&vssid=menu-viewer-entrypoint">Google Maps</a>
                    </div>
                </aside>
            </div>
        </div>
