...
<html lang="en">
  ...
  ?>
    ...
    <main id="home">
      ...
      <section class="hero">
        <div class="container">
          <h1 class="hero-title">Discover the Best Restaurants in Karachi</h1>
          <p class="hero-subtitle">
            Your ultimate guide to top eateries, cafes, and food spots across
            Karachi’s vibrant neighborhoods.
          </p>
          ...
          <!-- restaurant 1 -->
            <article class="card">
              ...
              <div class="content">
                ...
                <a class="btn btn-primary view-btn" href="<?php echo BASE_URL; ?>files/northnazimabad/NNrestaurant-1.php">View Details</a>
              </div>
            </article>
